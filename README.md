# Big Data Analytics Project Based Virtual Internship: PT. Kimia Farma Perfomance Analysis 2020-2023 

This is a Big Data Analytics Portfolio project that analyze Kimia Farma's performance evaluation for 2020-2023. The project included database schema design in BigQuery, complex data transformation with SQL, and geospatial visualization and sales performance in Looker Studio. The focus was on the accuracy of profitability metrics and mapping of branch stock availability.
...
* Top 10 Province Transaction and Province Net Sales
* Total Transaction per Gross Profit Percentage
...
* Market penetration strategies in other provinces through promotions or collaborations with local healthcare facilities.
* Prioritize stocking of products with a 30% margin across all branches to avoid losses due to stockouts and up selling vitamins/supplements with a 30% margin when consumers purchase lower-tier medications.
* Reviewing the storage and logistics of products with 10% and 15% margins to avoid costs. It's better to reduce the variety or adjust the prices to increase margins.
...
# Documentation
![Kimia Farma Performance Dashboard (2020-2023)](Images/Dashboard_Perfomance_Analytics_Kimia_Farma_Business_Year_2020-2023.jpg)
